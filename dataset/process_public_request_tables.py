...
if not data.empty:
    data.to_pickle(os.path.join(TRACE_DATA_DIR, 'huawei_25_traces_public_request_tables.pkl'))
    print("Processed data saved to ", os.path.join(TRACE_DATA_DIR, 'huawei_25_traces_public_request_tables.pkl'))
else:
    print("No data to save!")

with open(os.path.join(CURRENT_DIR, "public_request_tables.log"), "w") as log_file:
